...
variables_per_service = {
        "bot" : ["POSTGRES_USER", "POSTGRES_PASSWORD", "SKIP_UPDATES", "DELETE_MESSAGES_AFTER_SEC", "TOKEN", "TMP_DIR",
                 "JWT_SECRET_KEY", "ADMIN_CHAT_ID", "SALT_FOR_DERIVATION_RANDOM_SEED_FROM_USER_ID",
                 "KEYSTORE_PASSWORD", "USER_ID_HASH_SALT", "FAILED_BUILD_COUNT_ALLOWED", "FLOOD_WAIT_INTERVALS_SEC"],
        "build_worker": ["DATA_DIR", "TMP_DIR", "MOCK_BUILD", "WORKER_CONTROLLER_HOST", "WORKER_CHECK_INTERVAL_SEC",
                         "WORKER_JWT", "KEYSTORE_PASSWORD", "BUILD_DOCKER_IMAGE_NAME"],
        "clean_orders_queue": ["POSTGRES_USER", "POSTGRES_PASSWORD", "CONSIDER_WORKER_OFFLINE_AFTER_SEC",
                               "RESET_USER_BUILD_STATS_AFTER_SEC"],
